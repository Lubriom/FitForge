    ...
    <nav>
      <ul class="flex space-x-4 justify-between">
        ...
        <div class="flex space-x-2">
          <router-link to="/" class="text-white bg-quaternary-500 hover:bg-quinary-500 p-2 rounded-full"
            >Inicio</router-link
          >
          <router-link to="/about" class="text-white bg-quaternary-500 hover:bg-quinary-500 p-2 rounded-full"
